    ...
    <div className="min-h-screen bg-slate-50 pt-24 pb-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-slate-900 mb-3">Your Learning Journey</h1>
        ...
        {progress && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-slate-600 text-sm font-medium">Lessons Done</p>
                    <p className="text-2xl font-bold text-slate-900">{progress.lessonsCompleted}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-slate-900">{progress.totalScore}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-slate-900">{progress.badges.length}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-slate-600 text-sm font-medium">Current Track</p>
                    <p className="text-sm font-bold text-slate-900 line-clamp-2">{progress.courseTrack}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Progress Bar */}
            <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
              <h2 className="text-lg font-semibold text-slate-900 mb-4">Learning Progress</h2>
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-slate-700">DSA Mastery</span>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-slate-700">Project Building</span>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {progress.badges.map((badge, idx) => (
                  <div
                    key={idx}
                    className="flex flex-col items-center p-4 bg-gradient-to-br from-amber-50 to-yellow-50 rounded-lg border border-amber-200 hover:shadow-md transition-shadow"
                  >
